			...
			flags = 
			{
				...
				GET_PRE=function(obj)
					if not dball.capsuled(obj) then
						message("You'll need to reencapsulate it first. Press u, then - to access the floor.")
						return true, false
					end
				end
				CAPSULED=true
...
--[[
		...
		[SV_CAPSULE_BOAT] = {
			...
			desc =
			{
				"A small, personal watercraft, manufactured and distributed by capsule corporation.",
				"This craft is able to transport several people",
			}
			level = 50 weight = 1 cost = 50000
			allocation = { {50,1} }
			flags = 
			{
...
--[[
	...
	[TV_BOOTS] =
	{
		...
		[SV_FIGHTING_BOOTS] = {
			...
			level = 20 weight = 15 cost = 450
			allocation = { {18,3}, {20,2}, {23,2} }
			ac = 10
			flags = {
				ID_SKILL=SKILL_MARTIALARTS
				ID_VALUE=5
	...
	[TV_POLEARM] =
	{
		...
		[SV_SPEAR] = {
			...
			level = 19 weight = 20 cost = 350
			allocation = { {15,3}, {17,2}, {19,1}, {21,1}, {23,1} }
			flags = {
				WEAPON  = true
				MUST2H  = obvious(true)
		...
		[SV_BO_STAFF] = {
			...
			level = 18 weight = 70 cost = 300
			ac = 20
			allocation = { {14,2}, {16,1}, {18,1}, {21,1}, {23,1} }
			flags = {
				WEAPON  = true
				MUST2H  = obvious(true)
		...
		[SV_PUDAO] = {
			...
			level = 45 weight = 70 cost = 4000
			allocation = { {23,2}, {48,1} }
			flags = {
				WEAPON  = true
				MUST2H  = obvious(true)
	...
	[TV_SMALLARM] =
	{
		...
		[SV_KUBOTAN] = {
			...
			level = 3 weight = 5 cost = 100
			allocation = { {0,1}, {3,1}, {5,1}, {5,1}, {9,1}, {13,1} }
			flags = {
				WEAPON  = true
		...
		[SV_KNIFE] = {
			...
			allocation = { {0,2}, {3,2}, {5,1}, {7,1}, {9,1}, {13,1}, {15,1}, {20,1}, {23,1}, {33,1} }
			flags = {
				WEAPON  = true
		...
		[SV_IRON_FAN] = {
			...
			allocation = { {17,3}, {19,2}, {21,2}, {23,2} }
			ac = 10
			flags = {
				WEAPON  = true
		...
		[SV_HAMMER] = {
			...
			desc =
			{
				...
				"in size, the style of their use is also unique, with hammers typically wielded",
				"in pairs, and a skilled user will generally use them to thrust and parry at least",
				"as much as bash.",
			}
			...
			flags = {
				WEAPON  = true
				PAIRED = obvious(true)
				DAM = getter.damages{ CRUSH = {10,50}}
				DIFFICULTY = 8
				ID_SKILL=SKILL_WEAPONS
				ID_VALUE=12
				ITEM_CHINESE=true
		...
		[SV_STUN_BATON] = {
			...
			level = 20 weight = 20 cost = 1200
			allocation = { {21,2}, {25,2}, {33,2}, {43,1} }
			flags = {
				WEAPON  = true
	...
	[TV_SWORDARM] =
	{
		...
		[SV_JAGGED_SWORD] = {
			...
			level = 100 weight = 200 cost = 20000
			allocation = { {100,999} }
			flags = {
				WEAPON = true
				INSTA_ART = true
	...
	[TV_BODY_ARMOUR] =
	{
		...
		[SV_SHAOLIN_MONK_ROBES] = {
			name = "& shaolin monk robes"
			desc =
			{
				"These robes are made of medium weight cloth with many extra layers that are worn",
				"wrapped around oe another and tied in places that need to be held securely, such as",
				"the forearms and calves. But, they are left loose at joints in order to eliminate",
				"and restruictino of motion. Oh...and they're bright orange.",
			}
			level = 18 weight = 50 cost = 120
			allocation = { {10,3}, {13,2}, {15,1} }
			ac = 20
			flags = {
				ID_SKILL=SKILL_MARTIALARTS
	...
	[TV_BRACERS] =
	{
		...
		[SV_SHAOLIN_FOREARM_WRAPS] = {
			name = "& pair~ of shaolin forearm wraps"
			desc =
			{
				"Shaolin forearm wraps are essentially long strips of cloth. Rather than sliding",
				"into these, they are worn by wrapping layer afta layer of cloth over your forearms",
				"and securing it with ties afterwards. They offer very good protection with no",
				"Loss to range of motion.",
			}
			level = 20 weight = 6 cost = 100
			allocation = { {20,1}, {22,1},  }
			ac = 8
			flags = {
				ID_SKILL=SKILL_MARTIALARTS
				ID_VALUE=7
		...
		[SV_LIGHT_LEATHER_BRACERS] = {
			...
			desc =
			{
				...
				"They offer good protection with only a slight loss of range of motion.",
			}
	...
	[TV_SALVE] =
	{
		...
		[SV_ZHENG_GU_SHUI] = {
			...
			level = 18 weight = 2 cost = 100
			allocation = { {11,5}, {13,3}, {15,2}, {18,2}, {20,2}, {22,2} }
			dice = {1, 1}
			flags = {
				ID_SKILL=SKILL_MARTIALARTS
				ID_VALUE=5
	...
	[TV_PARCHMENT] =
	{
		...
		[35] = {
			define_sval_as = "SV_RELEASE_NOTES_091"
			name = "Dragonball T V091 Release Notes"
			display = '?' color = color.ORANGE
			desc =
			{
				"Party changes, new quests and content, major item drop revision, 60K new dialogue,",
				"lots of bug fixes."
...
--[[
	...
	[TV_MISC] = {
		...
		[SV_PORNO_MAGAZINE] = {
			name = "& porno magazine~"
			desc = {
				"With an unhealhy mix of cosplay girls, tentacles, butter dog, bukake, and a couple",
				"schoolgirls on subway trains, this magazine contains a broad sampling of Japanese",
				"pornography. Oh...you don't know what some of these things are? Good! Don't look them",
				"up. Well, ok. I'll explain the cosplay girls. Basically it's when people dress up as",
				"characters from anime. Anime babes tend to be cute, pretty and sexy all rolled into",
				"one, so it's fairly common for them to be sexualized. Though of course not all cosplay",
				"is sexual. Probably the vast majority of it isn't. But the cosplay that makes it into",
				"porno magazines certainly is. And that's the kind that's in this particular magazine.",
				"See? All sweet and innocent. Really.",
			}
			display = ')' color = color.RED
			level = 99 weight = 2 cost = 10
			allocation = { {100, 999} }
			flags = {
				PORN=true
			}
		...
		[SV_PLAYTEST] = {
			name = "& playtest device~"
			desc = {
				"'U'se this device to quickly swap level, skills and equipment amongst",
				"several basic character builds.",
			}
			display = '*' color = color.RED
			level = 99 weight = 1 cost = 1
			allocation = { {100, 999} }
			flags = {
				USEABLE=999999
				INSTA_ART=true
