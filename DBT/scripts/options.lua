...
option_page
{
	name = "Dragonball T Options"
	options =
	{
		{ name = "Never attack friendly monsters" variable = "chat_mode" default = true },
		{ name = "Push past party members instead of talking" variable = "party_mode" default = true },
		{ name = "Tameshiwari when able" variable = "tameshiwari_mode" default = true },
--		{ name = "Multi-Fire mode (not implemented)" variable = "dball.options_firing_mode" default = nil },
		{ name = "Prevent reload until ammo depleted" variable = "inhibit_reload" default = false },
	}
}
...
option_page
{
	...
	options =
	{
		...
		{ hidden = true name = "Auto-scum for good levels" variable = "auto_scum" default = nil },
		...
		{ hidden = true name = "Allow unusually small dungeon levels" variable = "small_levels" default = true },
...
option_page
{
	...
	options =
	{
		...
		{ name = "Center the view on the player (very slow)" variable = "center_player" default = true },
	},
}
...
option_page
{
	...
	options =
	{
		...
		{ name = "Allow notes to be written to a file" variable = "take_notes" default = nil },
		{ name = "Automatically note important events" variable = "auto_notes" default = nil },
